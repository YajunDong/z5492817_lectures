...
birthday = dt.datetime(1997,4,18,hour=0,minute=30)
now = dt.datetime.now()
alive = now - birthday
print(alive)
...
#how old will you be in 1340 days
futuredate = now + dt.timedelta(days=1340)
alive = futuredate - birthday
age = alive.days/365
print(age)
...
def time_it(func, parms):
    ...
    func(**parms)  # Call the provided function with the specified parameters
    ...
    return _mk_msg(days, hours, minutes, seconds + microseconds / 1e6)
def _test_time_it():
